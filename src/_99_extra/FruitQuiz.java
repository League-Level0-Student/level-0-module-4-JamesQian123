...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		question3 = new JLabel("<html>What animal does not exist?<br> A:")
		question2 = new JLabel("<html>Which team lost to Argentina in the world cup, for semi finals? <br> A: Australia <br> B: Netherlands <br> C: Croatia</html>");
		...
		//question2 = new JLabel("<html>Which is ")
		//question2 = new JLabel("<html>Which team lost to Argentina in the world cup, for semi finals? <br> A: Australia <br> B: Netherlands <br> C: Croatia</html>");
	}
